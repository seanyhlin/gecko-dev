...
function TestPresentationSessionTransport() {}

TestPresentationSessionTransport.prototype = {
  QueryInterface: XPCOMUtils.generateQI([Ci.nsIPresentationSessionTransport]),
  postMessage: function(msg) {},
  postBinaryMessage: function(msg) {},
  postBinaryStream: function(stream) {},
...
var testDevice = {
  ...
  simulateSessionRequest: function(url, presentationId, sessionTransport) {
    this._listener.onSessionRequest(this, url, presentationId, sessionTransport);
  },
};
...
function sessionRequest() {
  ...
  let testTransport = new TestPresentationSessionTransport();
  Services.obs.addObserver(function observer(subject, topic, data) {
    Services.obs.removeObserver(observer, topic);
  ...
  testDevice.simulateSessionRequest(testUrl, testPresentationId, testTransport);
}
