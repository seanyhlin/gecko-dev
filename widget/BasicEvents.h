...
#define NS_KEY_BEFORE_PRESS             (NS_WINDOW_START + 34)
#define NS_KEY_AFTER_PRESS              (NS_WINDOW_START + 35)
#define NS_KEY_BEFORE_DOWN              (NS_WINDOW_START + 36)
#define NS_KEY_AFTER_DOWN               (NS_WINDOW_START + 37)
#define NS_KEY_BEFORE_UP                (NS_WINDOW_START + 38)
#define NS_KEY_AFTER_UP                 (NS_WINDOW_START + 39)
